...
|---|---|---|---|
| 1 | **L1 shell scaffold** | `2026-05-24-pof-ecw-phase-01-shell.md` | ✏️ written, ready to execute |
| 2 | **Entity Inspector primitive** | `2026-05-24-pof-ecw-phase-02-entity-inspector.md` | ⏳ written when Phase 1 lands |
| 3 | **Catalog Hub** | `2026-05-24-pof-ecw-phase-03-catalog-hub.md` | ⏳ |
