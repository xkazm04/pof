# Vendor / Shop — Catalog Pipeline Brief

**Category:** Systems · **Catalog:** `vendors` (new) · **Description:** NPC merchant with inventory, pricing, and restock rules.
...
**Wandering Merchant** — drive this single entity through every step below, idea → real UE asset → passing test gate.

## Pipeline (from game_catalog_pipelines.xlsx)
- [ ] 1. Concept Brief & Role  
  _agent: TBD-by-session · reuse/gap: TBD-by-session_
- [ ] 2. Inventory Pool Logic  
  _agent: TBD-by-session · reuse/gap: TBD-by-session_
- [ ] 3. Pricing & Markup Rules  
  _agent: TBD-by-session · reuse/gap: TBD-by-session_
- [ ] 4. Restock & Rotation Rules  
  _agent: TBD-by-session · reuse/gap: TBD-by-session_
- [ ] 5. Reputation / Faction Modifiers  
  _agent: TBD-by-session · reuse/gap: TBD-by-session_
- [ ] 6. Buy/Sell/Repair Rule Set  
  _agent: TBD-by-session · reuse/gap: TBD-by-session_
- [ ] 7. Economy Sim Hook  
  _agent: TBD-by-session · reuse/gap: TBD-by-session_
- [ ] 8. Vendor Dialog Snippets  
  _agent: TBD-by-session · reuse/gap: TBD-by-session_
- [ ] 9. Shop UI Layout  
  _agent: TBD-by-session · reuse/gap: TBD-by-session_
- [ ] 10. VFX (purchase confirm)  
  _agent: TBD-by-session · reuse/gap: TBD-by-session_
- [ ] 11. SFX (coins, denied)  
  _agent: TBD-by-session · reuse/gap: TBD-by-session_
- [ ] 12. Localization  
  _agent: TBD-by-session · reuse/gap: TBD-by-session_
- [ ] 13. Pricing Balance Gate  
  _agent: TBD-by-session · reuse/gap: TBD-by-session_
- [ ] 14. UE Asset Packaging  
  _agent: TBD-by-session · reuse/gap: TBD-by-session_

## PoF integration
- **Catalog:** `vendors` (registered in Phase A).
