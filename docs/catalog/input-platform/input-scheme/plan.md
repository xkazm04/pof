# Input Scheme — Catalog Pipeline Brief

**Category:** Input & Platform · **Catalog:** `input-schemes` (new) · **Description:** Bindings and feel for one input device family.
...
**Gamepad Default** — drive this single entity through every step below, idea → real UE asset → passing test gate.

## Pipeline (from game_catalog_pipelines.xlsx)
- [ ] 1. Concept Brief & Device  
  _agent: TBD-by-session · reuse/gap: TBD-by-session_
- [ ] 2. Action Mapping Schema  
  _agent: TBD-by-session · reuse/gap: TBD-by-session_
- [ ] 3. Context Stack Logic (menu/play/vehicle)  
  _agent: TBD-by-session · reuse/gap: TBD-by-session_
- [ ] 4. Rebinding UI & Persistence  
  _agent: TBD-by-session · reuse/gap: TBD-by-session_
- [ ] 5. Deadzone & Sensitivity Rules  
  _agent: TBD-by-session · reuse/gap: TBD-by-session_
- [ ] 6. Haptics / Rumble Profiles  
  _agent: TBD-by-session · reuse/gap: TBD-by-session_
- [ ] 7. Accessibility Options (toggle, hold, remap)  
  _agent: TBD-by-session · reuse/gap: TBD-by-session_
- [ ] 8. Glyph Set 2D  
  _agent: TBD-by-session · reuse/gap: TBD-by-session_
- [ ] 9. Tutorial Prompt Logic  
  _agent: TBD-by-session · reuse/gap: TBD-by-session_
- [ ] 10. Localization  
  _agent: TBD-by-session · reuse/gap: TBD-by-session_
- [ ] 11. Platform Cert Compliance  
  _agent: TBD-by-session · reuse/gap: TBD-by-session_
- [ ] 12. Feel Test Gate  
  _agent: TBD-by-session · reuse/gap: TBD-by-session_
- [ ] 13. UE Input Asset Packaging  
  _agent: TBD-by-session · reuse/gap: TBD-by-session_

## PoF integration
- **Catalog:** `input-schemes` (registered in Phase A).
