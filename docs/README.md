...
| [architecture/ui-shell.md](architecture/ui-shell.md) | The `/layout` homepage, Category→Catalog→Entity tree, the Baseline composition screen, the server-backed produce→persist→rollup loop |
...
| [catalog/AUTHORING.md](catalog/AUTHORING.md) | How to author a row — the recipe + the per-CLI loop |
