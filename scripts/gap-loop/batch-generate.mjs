...
const SPECIAL = {
  ...
  'materials|Maps': { prompt: 'seamless PBR albedo texture of weathered grey stone, tileable, flat orthographic top-down, even lighting, high detail surface, no object, no text', subject: 'a seamless tileable PBR albedo texture of weathered stone, flat and evenly lit, no 3D object' },
