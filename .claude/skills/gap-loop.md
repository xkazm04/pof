...
- **Leonardo 2D**: `scripts/visual-gen/` (LEONARDO_API_KEY in `.env`). Every gen is download-then-delete. Face-priority prompts for characters; gate BEFORE spending downstream credits.
