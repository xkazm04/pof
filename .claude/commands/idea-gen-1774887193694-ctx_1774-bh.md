...
## Target Context
- Context ID: ctx_1774443567442_le2wgjw
- Context Name: Level Design
...
**Context Description**:
Level design view with flow editor, procedural level wizard, streaming zone planner, room detail panel, difficulty arc chart. SQLite persistence for level data.

**Files in this Context** (12 files):
- src/components/modules/content/level-design/DifficultyArcChart.tsx
...

{
  ...
  "project_id": "994c4d7f-5b3e-42be-b345-ef6421f4ee3e",
  "context_id": "ctx_1774443567442_le2wgjw",
  "scan_type": "bug_hunter",
  "category": "<category>",
  "title": "<title>",
