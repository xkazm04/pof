...
## Target Context
- Context ID: ctx_1774443618007_g6184fo
- Context Name: Gameplay Subsystems
...
**Context Description**:
Dialogue, input binding, physics, save/load, multiplayer views. Quest generator for procedural quest creation. Core gameplay subsystem configuration tools.

**Files in this Context** (7 files):
- src/components/modules/game-systems/DialogueView.tsx
...

{
  ...
  "project_id": "994c4d7f-5b3e-42be-b345-ef6421f4ee3e",
  "context_id": "ctx_1774443618007_g6184fo",
  "scan_type": "bug_hunter",
  "category": "<category>",
  "title": "<title>",
