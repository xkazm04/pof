...
## Target Context
- Context ID: ctx_1774443607415_l5jfnp6
- Context Name: Build & Packaging
...
**Context Description**:
Build config selector, comparison, history dashboard, cook settings. Packaging view with platform profiles. Build profiles DB, version manager, UAT command generator. Blueprint parser and transpiler.
...

{
  ...
  "project_id": "994c4d7f-5b3e-42be-b345-ef6421f4ee3e",
  "context_id": "ctx_1774443607415_l5jfnp6",
  "scan_type": "bug_hunter",
  "category": "<category>",
  "title": "<title>",
