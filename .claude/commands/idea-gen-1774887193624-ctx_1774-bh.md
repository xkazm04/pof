...
## Target Context
- Context ID: ctx_1774443632506_j3fa3ha
- Context Name: Evaluation Engine & Quality
...
**Context Description**:
3-pass evaluation engine (structure/quality/performance), deep eval, insight generator, correlation engine, finding collector, fix plan generator. Combined health scoring and GDD compliance.
...

{
  ...
  "project_id": "994c4d7f-5b3e-42be-b345-ef6421f4ee3e",
  "context_id": "ctx_1774443632506_j3fa3ha",
  "scan_type": "bug_hunter",
  "category": "<category>",
  "title": "<title>",
