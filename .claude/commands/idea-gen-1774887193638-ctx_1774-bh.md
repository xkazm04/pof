...
## Target Context
- Context ID: ctx_1774443786038_wf2dmra
- Context Name: Task System & Prompt Engineering
...
**Context Description**:
Unified CLI task abstraction with callback system (@@CALLBACK markers). Fluent prompt builder with 6-section composable prompts. Prompt evolution with A/B testing, mutations, clustering. Prototype chat UI. Task DAG orchestrator and workflow templates.
...
- src/components/prototype/chat/ConversationShell.tsx
- src/components/prototype/chat/ChatMessages.tsx
- src/components/prototype/chat/ChatInput.tsx
- src/components/prototype/chat/SlashCommandMenu.tsx
- src/components/prototype/chat/useChatOverlay.ts
...

{
  ...
  "project_id": "994c4d7f-5b3e-42be-b345-ef6421f4ee3e",
  "context_id": "ctx_1774443786038_wf2dmra",
  "scan_type": "bug_hunter",
  "category": "<category>",
  "title": "<title>",
