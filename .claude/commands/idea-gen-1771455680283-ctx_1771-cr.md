...
## Target Context
- Context ID: ctx_1771455485095_fpwbaz8
- Context Name: Performance Profiling & Pattern Library
...
**Context Description**:
Profile UE5 performance with CSV parsing, triage engine, and sample data generation. Maintain a pattern library of reusable code patterns, asset code oracle for C++ semantic parsing, and asset scout for codebase exploration.
...

{
  ...
  "project_id": "994c4d7f-5b3e-42be-b345-ef6421f4ee3e",
  "context_id": "ctx_1771455485095_fpwbaz8",
