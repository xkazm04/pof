...
## Target Context
- Context ID: ctx_1774443645717_1p9n0ak
- Context Name: Project Health & Crash Analysis
...
**Context Description**:
Project health dashboard, holistic health view, crash analyzer with error fingerprinting, codebase archeologist, asset code oracle. Performance profiling with CSV parsing and triage engine.
...
- src/types/codebase-archeologist.ts
...

{
  ...
  "project_id": "994c4d7f-5b3e-42be-b345-ef6421f4ee3e",
  "context_id": "ctx_1774443645717_1p9n0ak",
  "scan_type": "bug_hunter",
  "category": "<category>",
  "title": "<title>",
