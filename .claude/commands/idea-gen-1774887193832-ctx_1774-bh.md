...
## Target Context
- Context ID: ctx_1774443769314_jn951od
- Context Name: CLI Terminal
...
**Context Description**:
Claude Code CLI terminal with stream-json parsing, session management. Compact and inline terminal modes. Output formatters: code highlighting, error cards, build summaries, warning aggregation, suggested actions. Input history and scroll sync.
...
- src/components/cli/CodeBlockHighlighter.tsx
...
- src/components/cli/AntiPatternWarning.tsx
- src/components/cli/UE5BuildParser.ts
- src/components/cli/index.ts
- src/components/cli/types.ts
- src/components/cli/useInputHistory.ts
- src/components/cli/useScrollSync.ts
...
- src/components/cli/skills/index.ts
...

{
  ...
  "project_id": "994c4d7f-5b3e-42be-b345-ef6421f4ee3e",
  "context_id": "ctx_1774443769314_jn951od",
  "scan_type": "bug_hunter",
  "category": "<category>",
  "title": "<title>",
