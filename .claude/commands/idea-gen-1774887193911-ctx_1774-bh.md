...
## Target Context
- Context ID: ctx_1774443859267_lz9mw7j
- Context Name: Game Director & Regression
...
**Context Description**:
Game director module with session tracking, findings explorer, regression tracker. Director overview and session detail views. SQLite persistence for game director sessions.
...
- src/types/game-director.ts
- src/types/regression-tracker.ts
...

{
  ...
  "project_id": "994c4d7f-5b3e-42be-b345-ef6421f4ee3e",
  "context_id": "ctx_1774443859267_lz9mw7j",
  "scan_type": "bug_hunter",
  "category": "<category>",
  "title": "<title>",
