...
## Target Context
- Context ID: ctx_1774443817555_lzwnneo
- Context Name: UI Primitives & Shared Infrastructure
...
**Context Description**:
Reusable UI components: Badge, Button, Card, EmptyState, ProgressRing, Tooltip, etc. Core infrastructure: event bus, lifecycle protocol, SQLite DB, logger, API utils, constants, chart colors, Result type, error memory, file watcher, search index.

**Files in this Context** (40 files):
...
- src/components/ui/InteractivePill.tsx
...
- src/components/ui/TruncateWithTooltip.tsx
...

{
  ...
  "project_id": "994c4d7f-5b3e-42be-b345-ef6421f4ee3e",
  "context_id": "ctx_1774443817555_lzwnneo",
  "scan_type": "bug_hunter",
  "category": "<category>",
  "title": "<title>",
