...
## Target Context
- Context ID: ctx_1771455368691_z8dco47
- Context Name: Animation Pipeline
...
**Context Description**:
Manage UE5 animation blueprints through guided checklists, state machine design, and best-practice prompts. Scan animation assets, evaluate montages/blendspaces, and generate C++ animation code.
...
- src/app/api/checklist-metadata/route.ts
...

{
  ...
  "project_id": "994c4d7f-5b3e-42be-b345-ef6421f4ee3e",
  "context_id": "ctx_1771455368691_z8dco47",
