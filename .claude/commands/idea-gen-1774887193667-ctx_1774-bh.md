...
## Target Context
- Context ID: ctx_1774443661444_30akdji
- Context Name: Evaluator UI Dashboards
...
**Context Description**:
All evaluator UI components: aggregate quality dashboard, deep eval results, dependency graph, cross-module dashboards, GDD/game design doc views, nexus view, unified summary, holistic health, calendar roadmap, batch review, prompt evolution view.
...

{
  ...
  "project_id": "994c4d7f-5b3e-42be-b345-ef6421f4ee3e",
  "context_id": "ctx_1774443661444_30akdji",
  "scan_type": "bug_hunter",
  "category": "<category>",
  "title": "<title>",
