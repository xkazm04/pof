...
## Target Context
- Context ID: ctx_1771455393027_kyip6va
- Context Name: Materials, Models & UI/HUD
...
**Context Description**:
Configure material parameters, explore pattern catalogs, apply style transfer, build post-process stacks, manage 3D asset inventories with pipeline diagrams, and design in-game UI/HUD elements like inventory grids and menu flows.
...

{
  ...
  "project_id": "994c4d7f-5b3e-42be-b345-ef6421f4ee3e",
  "context_id": "ctx_1771455393027_kyip6va",
