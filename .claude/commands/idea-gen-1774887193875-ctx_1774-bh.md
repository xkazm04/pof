...
## Target Context
- Context ID: ctx_1774443798694_xk0wmsb
- Context Name: Layout & Navigation
...
**Context Description**:
App shell with two-level sidebar navigation, top bar, module renderer, CLI bottom panel, activity feed panel, global search, event bus dev tools. Module shell wrapper and error boundary.
...

{
  ...
  "project_id": "994c4d7f-5b3e-42be-b345-ef6421f4ee3e",
  "context_id": "ctx_1774443798694_xk0wmsb",
  "scan_type": "bug_hunter",
  "category": "<category>",
  "title": "<title>",
