...
## Target Context
- Context ID: ctx_1774443845404_6awgoey
- Context Name: Session Tracking & Telemetry
...
**Context Description**:
Session logging, session analytics, telemetry DB persistence. Activity feed store and bridge hook. Session analytics dashboard, weekly digest view. Progress tracking and project progress API.
...
- src/types/session-analytics.ts
...

{
  ...
  "project_id": "994c4d7f-5b3e-42be-b345-ef6421f4ee3e",
  "context_id": "ctx_1774443845404_6awgoey",
  "scan_type": "bug_hunter",
  "category": "<category>",
  "title": "<title>",
