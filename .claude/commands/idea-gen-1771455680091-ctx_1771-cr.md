...
## Target Context
- Context ID: ctx_1771455424332_zjjfu97
- Context Name: Implementation Planning & Roadmap
...
**Context Description**:
Generate implementation plans with effort estimation, impact scoring, and layout visualization. Includes the plan-matrix map for visual planning, module scan imports, milestone deadlines, workflow DAG orchestration, and project progress tracking.

**Files in this Context** (20 files):
- src/components/modules/core-engine/ImplementationPlan.tsx
- src/components/modules/core-engine/PlanMatrixMap.tsx
- src/components/modules/core-engine/ScanTab.tsx
...

{
  ...
  "project_id": "994c4d7f-5b3e-42be-b345-ef6421f4ee3e",
  "context_id": "ctx_1771455424332_zjjfu97",
