...
## Target Context
- Context ID: ctx_1771455383411_dpr5c4t
- Context Name: Level Design & Procedural Generation
...
**Context Description**:
Design game levels with spatial diagrams, room detail panels, difficulty arc charts, and procedural level generation wizard. Manage level flow, streaming zones, and sync status with UE5 project.
...

{
  ...
  "project_id": "994c4d7f-5b3e-42be-b345-ef6421f4ee3e",
  "context_id": "ctx_1771455383411_dpr5c4t",
