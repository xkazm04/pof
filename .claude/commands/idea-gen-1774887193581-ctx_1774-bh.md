...
## Target Context
- Context ID: ctx_1774443556335_pae7jq2
- Context Name: Materials & Visual Effects
...
**Context Description**:
Material parameter configurator, layer graph, pattern catalog, style transfer. Post-process stack builder with GPU cost estimation and effect presets. Prompt builders for materials and post-process.
...

{
  ...
  "project_id": "994c4d7f-5b3e-42be-b345-ef6421f4ee3e",
  "context_id": "ctx_1774443556335_pae7jq2",
  "scan_type": "bug_hunter",
  "category": "<category>",
  "title": "<title>",
