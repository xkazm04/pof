...
## Target Context
- Context ID: ctx_1774443706369_fy3tbhh
- Context Name: Procedural Generation & Rigging
...
**Context Description**:
Procedural engine for terrain, dungeon, and vegetation generation. Auto-rig system with character rig presets. Import automation with UE5 templates.

**Files in this Context** (8 files):
- src/components/modules/visual-gen/procedural-engine/ProceduralEngineView.tsx
- src/components/modules/visual-gen/procedural-engine/useProceduralStore.ts
...

{
  ...
  "project_id": "994c4d7f-5b3e-42be-b345-ef6421f4ee3e",
  "context_id": "ctx_1774443706369_fy3tbhh",
  "scan_type": "bug_hunter",
  "category": "<category>",
  "title": "<title>",
