...
## Target Context
- Context ID: ctx_1774443544232_p1otrhx
- Context Name: Animation & Audio
...
**Context Description**:
Animation checklist, state machine editor, AI combo choreographer. Audio codegen, scene painter, spatial audio generator. Per-module prompt builders for animation and audio domains.
...
- src/hooks/useAudioScene.ts
- src/types/audio-scene.ts
- src/app/api/audio-scene/route.ts
- src/app/api/audio-codegen/route.ts
...

{
  ...
  "project_id": "994c4d7f-5b3e-42be-b345-ef6421f4ee3e",
  "context_id": "ctx_1774443544232_p1otrhx",
  "scan_type": "bug_hunter",
  "category": "<category>",
  "title": "<title>",
