...
## Target Context
- Context ID: ctx_1771455477982_x9zdru3
- Context Name: Crash Analysis & Regression Tracking
...
**Context Description**:
Analyze crash dumps with pattern detection and sample crash inspection. Track regressions across builds with automated detection, error fingerprinting, and error memory for recurring issues.
...

{
  ...
  "project_id": "994c4d7f-5b3e-42be-b345-ef6421f4ee3e",
  "context_id": "ctx_1771455477982_x9zdru3",
