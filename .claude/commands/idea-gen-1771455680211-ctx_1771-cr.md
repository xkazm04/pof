...
## Target Context
- Context ID: ctx_1771455455599_jj08ypp
- Context Name: Packaging & Build Management
...
**Context Description**:
Configure platform-specific build profiles, manage build history, compare builds, track package sizes with trend charts, and generate UAT commands. Includes cook settings and platform profile cards.
...
- src/components/modules/game-systems/SizeTrendChart.tsx
...

{
  ...
  "project_id": "994c4d7f-5b3e-42be-b345-ef6421f4ee3e",
  "context_id": "ctx_1771455455599_jj08ypp",
