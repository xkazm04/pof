...
- Name: catalog-pipeline-walker.spec.ts >> catalog pipeline: save-points >> walks 12 steps to config-complete acceptance + persists
- Location: e2e\catalog-pipeline-walker.spec.ts:26:9

# Error details

```
Error: save-points · Concept Brief did not persist with status pass

save-points · Concept Brief did not persist with status pass
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - banner [ref=e4]:
      - generic [ref=e6]:
        - text: PoF·LAB
        - generic [ref=e7]: sheet · save-points
      - generic [ref=e8]:
    ...
    - generic [ref=e27]:
      ...
      - generic [ref=e41]:
        - banner [ref=e42]:
          - generic [ref=e43]:
            - generic [ref=e44]: Save / Checkpoint
            - heading "Bonfire Checkpoint" [level=1] [ref=e45]
          - generic [ref=e46]:
            - generic [ref=e47]:
            ...
            - generic [ref=e50]:
              ...
              - generic [ref=e52]: An interact-to-save world checkpoint.
        - generic [ref=e53]:
          - complementary [ref=e54]:
            ...
            - tree "Catalogs" [ref=e57]:
              ...
              - generic [ref=e126]:
                ...
                - generic [ref=e144]:
                  - treeitem "Save / Checkpoint 0/1" [selected] [ref=e145] [cursor=pointer]:
                    - generic [ref=e146]: Save / Checkpoint
                    - generic [ref=e147]: 0/1
                  - 'button "Bonfire Checkpoint: pending" [ref=e149] [cursor=pointer]':
                    - generic [ref=e150]: ○
                    - generic [ref=e151]: Bonfire Checkpoint
              - generic [ref=e152]:
          ...
          - complementary [ref=e180]:
            ...
            - list "Pipeline steps" [ref=e183]:
              ...
              - 'button "State Schema: passed, tier L0" [ref=e193] [cursor=pointer]':
                - generic [ref=e195]: ✓
                - generic [ref=e196]:
                  - generic [ref=e197]: "02"
                  - text: State Schema
                  - generic "Server verdict differs" [ref=e198]: ≠
              - 'button "Versioning & Migration: passed, tier L0" [ref=e200] [cursor=pointer]':
                - generic [ref=e202]: ✓
                - generic [ref=e203]:
                  - generic [ref=e204]: "03"
                  - text: Versioning & Migration
                  - generic "Server verdict differs" [ref=e205]: ≠
              - 'button "Save Triggers: passed, tier L0" [ref=e207] [cursor=pointer]':
                - generic [ref=e209]: ✓
                - generic [ref=e210]:
                  - generic [ref=e211]: "04"
                  - text: Save Triggers
                  - generic "Server verdict differs" [ref=e212]: ≠
              - 'button "Cloud / Local Storage: passed, tier L0" [ref=e214] [cursor=pointer]':
                - generic [ref=e216]: ✓
                - generic [ref=e217]:
                  - generic [ref=e218]: "05"
                  - text: Cloud / Local Storage
                  - generic "Server verdict differs" [ref=e219]: ≠
              - 'button "Conflict Resolution: passed, tier L0" [ref=e221] [cursor=pointer]':
                - generic [ref=e223]: ✓
                - generic [ref=e224]:
                  - generic [ref=e225]: "06"
                  - text: Conflict Resolution
                  - generic "Server verdict differs" [ref=e226]: ≠
              - 'button "Corruption Recovery: passed, tier L0" [ref=e228] [cursor=pointer]':
                - generic [ref=e230]: ✓
                - generic [ref=e231]:
                  - generic [ref=e232]: "07"
                  - text: Corruption Recovery
                  - generic "Server verdict differs" [ref=e233]: ≠
              - 'button "Slots UI: passed, tier L0" [ref=e235] [cursor=pointer]':
                - generic [ref=e237]: ✓
                - generic [ref=e238]:
                  - generic [ref=e239]: "08"
                  - text: Slots UI
                  - generic "Server verdict differs" [ref=e240]: ≠
              - 'button "Load-Time Budget: passed, tier L0" [ref=e242] [cursor=pointer]':
                - generic [ref=e244]: ✓
                - generic [ref=e245]:
                  - generic [ref=e246]: "09"
                  - text: Load-Time Budget
          ...
          - main [ref=e265]:
            - status [ref=e266]:
              - generic [ref=e267]:
                ...
                - 'generic "Run live test: Test Gate — live-UE runner not yet run: PoF.SavePoints.RoundTrip" [ref=e269]':
                  - strong [ref=e270]: "Run live test:"
                  - text: Test Gate
                  - generic [ref=e271]: "— live-UE runner not yet run: PoF.SavePoints.RoundTrip"
            ...
            - generic [ref=e284]:
              - generic [ref=e285]:
                - generic [ref=e286]:
                  ...
                  - generic [ref=e289]:
                    - generic [ref=e290]: 1569 / 300 chars
              ...
              - generic [ref=e303]:
                - generic [ref=e304]:
                  ...
                  - generic [ref=e306]: "Bonfire Checkpoint is PoF's primary persistence anchor — a bonfire-style world checkpoint that the player interacts with to commit progress to disk. Checkpoints belong to the post-Sundering dark-fantasy setting: weathered stone structures or runic braziers rekindled by the player, providing a moment of earned respite in a soldier's world (canon game-tone: earned, not gifted). The system is designed around two invariants: (1) only DISCRETE world-state mutations persist — State.Enemy.Defeated.*, quest stage completions, zone unlocks, and committed attribute deltas written to DT_AttributeDefaults rows; (2) ephemeral runtime state — current AI blackboard values, in-flight GAS effects, ongoing combat — is deliberately DISCARDED on session end and rebuilt from canonical data rows on load (canon state-graph-fsm-wiring). This \"discrete-only\" contract keeps save files small, forward-compatible, and corruption-resistant. A bonfire interaction triggers a short (~0.3 s) commit window with a tactile SFX sting and a HUD save-indicator flash, then the game continues uninterrupted. Autosave fires on the same path (same serializer, same slot rules) on zone transitions and quest-stage completions. Multiple save slots are supported (default 3); slot selection is via WBP_SaveSlots surfaced from the pause menu and the main-menu load screen, bound per proj-hud-binding. UE realization: UARPGSaveGame (USaveGame subclass) + BP_Bonfire (Blueprint child of AARPGInteractableBase, config — no new C++) + UARPGSaveSubsystem (GameInstanceSubsystem) + DA_SavePoint data asset."
                - generic [ref=e307]:
