...
## Target File
- Source/PoF/Materials/ARPGSurface.cpp (around line 42)

Start by reading this file to understand the current implementation.

## Issue to Fix
**Module**: Materials & Shaders
**Category**: Shader
**Severity**: high

The surface master is recompiled per instance.

## Suggested Fix
Cache the MID and reuse it.

## Instructions
1. Read Source/PoF/Materials/ARPGSurface.cpp to understand the current code
