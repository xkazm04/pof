...
- **Verification**: L2: cppSymbolExists(UARPGItemDefinition) + seedRowPresent(author_items.py, DA_<slug>); L3: VSItemsDefinitionsTest — DA loaded + requiredLevel/slot/rarity fields assert correct
