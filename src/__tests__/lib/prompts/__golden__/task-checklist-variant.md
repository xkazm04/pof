...
@@CALLBACK:cb-TEST
{
  "data": {
    ...
    "buildOk": true,          // did PoF build after your change (judged from the newest Saved/Logs/*.log, NOT the exit code)
...
The following fields will be added automatically — do NOT include them:
- `catalogId`: `"checklist-runs"`
- `entityId`: `"arpg-combat"`
- `step`: `"combat-hit-detect"`
- `status`: `"pending"`
- `tier`: `"L0"`
- `promptVersion`: `"q2"`
- `promptVariantId`: `"var-experimental-1"`
