 ...
 */
export function diabloUeRoot(name: string, id?: string, shared: ReadonlySet<string> = new Set(), folder = 'Bestiary'): { root: string; slug: string } {
  ...
  return { root: `/Game/Diablo/${folder}/${slug}`, slug };
}
