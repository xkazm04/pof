...
export const DIABLO1_CANON: readonly ProjectRule[] = [
  ...
  { id: 'd1-timing-law', profile: 'diablo1', category: 'game', scope: 'bestiary', title: 'Game time and movement law (engine-derived)',
    body: 'Game time, derived from the engine: the simulation advances 20 ticks per second and every monster runs its AI on every tick. A walk moves exactly one tile and lasts the walk animation\'s frames plus 1 tick, for monsters and heroes alike; an attack lasts its attack animation\'s frames and lands on its action frame.',
  ...
  { id: 'd1-ai-zombie-law', profile: 'diablo1', category: 'game', scope: 'bestiary', title: 'Zombie AI law (engine-derived)',
    body: 'Zombie AI, derived from the engine: while standing it acts on only (2 x intelligence + 10)% of ticks; when it acts beside its target it attacks, otherwise it walks toward it.',
    refs: ['https://github.com/diasurgical/devilutionX/blob/4138a82/Source/monster.cpp (ZombieAi)'] },
  { id: 'd1-ai-skeleton-melee-law', profile: 'diablo1', category: 'game', scope: 'bestiary', title: 'SkeletonMelee AI law (engine-derived)',
    body: 'SkeletonMelee AI, derived from the engine: beside its target it attacks on (2 x intelligence + 20)% of decisions and otherwise pauses (10 - 2 x intelligence) plus 0-9 ticks, then attacks; away from its target it steps on (65 + 4 x intelligence)% of decisions and otherwise pauses (15 - 2 x intelligence) plus 0-9 ticks, then steps.',
    refs: ['https://github.com/diasurgical/devilutionX/blob/4138a82/Source/monster.cpp (SkeletonAi, AiDelay)'] },
  { id: 'd1-ai-skeleton-ranged-law', profile: 'diablo1', category: 'game', scope: 'bestiary', title: 'SkeletonRanged AI law (engine-derived)',
    body: 'SkeletonRanged AI, derived from the engine: it never walks toward its target; when the target is within 4 tiles it may walk away from it; otherwise it shoots an arrow on (2 x intelligence + 3)% of ticks when its line to the target is clear.',
    refs: ['https://github.com/diasurgical/devilutionX/blob/4138a82/Source/monster.cpp (SkeletonBowAi, StartRangedAttack MissileID::Arrow)'] },
