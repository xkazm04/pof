...
export { buildScenarioInbox, buildScenarioArgs, newestShot, pickActionShot, captureScenarioFrame, type CaptureScenarioFrameOptions, type CaptureScenarioSpec, type CaptureScenarioInput } from './capture';
