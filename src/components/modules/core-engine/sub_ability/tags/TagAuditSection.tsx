...
import {
  MODULE_COLORS, STATUS_SUCCESS, STATUS_WARNING, STATUS_ERROR, ACCENT_RED,
  OVERLAY_WHITE, withOpacity, OPACITY_5, OPACITY_6, OPACITY_8, OPACITY_12, OPACITY_20, OPACITY_37,
} from '@/lib/chart-colors';
import { SurfaceCard } from '@/components/ui/SurfaceCard';
import { SectionLabel, PipelineFlow } from '../../unique-tabs/_shared';
import type { AuditCategory, TagDetail } from '../_shared/data';
