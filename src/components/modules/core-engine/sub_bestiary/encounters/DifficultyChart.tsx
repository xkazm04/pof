...
import { ACCENT_RED, STATUS_SUCCESS, STATUS_NEUTRAL, OVERLAY_WHITE,
  withOpacity, OPACITY_15, OPACITY_6, OPACITY_8, OPACITY_30, OPACITY_40, OPACITY_50,
} from '@/lib/chart-colors';
import type { DifficultyPoint } from '../_shared/data';
...
export function DifficultyChart({ series }: DifficultyChartProps) {
  ...
  return (
    <div className="min-h-[200px] bg-surface-deep/30 rounded-lg p-2">
      ...
      >
        {/* Zones */}
        <rect x={PAD_L} y={toY(100)} width={PLOT_W} height={toY(70) - toY(100)} fill={withOpacity(ACCENT_RED, OPACITY_8)} />
        ...
        {/* Zone labels */}
        <text x={PAD_L + 3} y={toY(88)} className="text-xs font-mono" fill={withOpacity(ACCENT_RED, OPACITY_50)}>DANGER</text>
