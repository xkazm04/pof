...
import { ACCENT, LOOT_SUBTABS, type LootSubtab } from './_shared/data';
...
export function NarrativeBreadcrumb({ activeTab, onNavigate }: { activeTab: LootSubtab; onNavigate: (tab: LootSubtab) => void }) {
