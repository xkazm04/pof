    ...
    <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}>
      ...
      <BlueprintPanel color={ACCENT} className="p-3">
        <HeatmapGrid
          ...
          accent={ACCENT}
        />
        <div className="flex items-center gap-4 mt-3 text-[10px] font-mono uppercase tracking-[0.15em] text-text-muted">
    ...
    <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15 }}>
      ...
      <BlueprintPanel color={ACCENT} className="p-3">
          ...
          {FRAME_TIME_BARS.map((bar) => {
            ...
            return (
              <div key={bar.label} className="flex items-center gap-3">
                <span className="text-[10px] font-mono uppercase tracking-[0.15em] w-24 text-right text-text-muted">{bar.label}</span>
        ...
        <div className="mt-2.5 relative">
          <div className="text-[10px] font-mono uppercase tracking-[0.15em] text-text-muted mb-1">STACKED FRAME BUDGET</div>
          ...
          <div className="flex justify-between mt-1">
            <span className="text-[10px] font-mono uppercase tracking-[0.15em] text-text-muted">0ms</span>
            <span className="text-[10px] font-mono uppercase tracking-[0.15em]" style={{ color: `${ACCENT}cc` }}>{FRAME_TARGET_MS.toFixed(2)}ms (60fps)</span>
          </div>
        </div>
      </BlueprintPanel>
    </motion.div>
