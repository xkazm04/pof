...
import {
  ACCENT_CYAN, OPACITY_8, OPACITY_30,
  ...
  return (
    <BlueprintPanel className="p-3">
      ...
      <div className="flex flex-wrap items-center gap-2 mb-3">
        ...
        />
        <button onClick={() => setDroughtPityEnabled(v => !v)} className="text-2xs font-mono px-2 py-0.5 rounded border transition-all hover:opacity-80 ml-auto"
          style={{ borderColor: droughtPityEnabled ? `${STATUS_SUCCESS}${OPACITY_30}` : 'var(--border)', backgroundColor: droughtPityEnabled ? `${STATUS_SUCCESS}${OPACITY_8}` : 'transparent', color: droughtPityEnabled ? STATUS_SUCCESS : 'var(--text-muted)' }}>
