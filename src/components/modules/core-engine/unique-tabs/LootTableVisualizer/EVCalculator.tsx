          ...
          {RARITY_TIERS.map(tier => (
            <div key={tier.name} className="flex items-center gap-1.5 rounded-lg border px-2 py-1" style={{ borderColor: `${tier.color}${OPACITY_20}`, backgroundColor: `${tier.color}08` }}>
              ...
              <input type="number" min={0} step={5} value={rarityGold[tier.name]}
                ...
                className="w-16 bg-surface-deep/50 border border-border/40 rounded px-1.5 py-0.5 text-xs font-mono text-text text-right focus:outline-none focus:ring-1 focus:ring-orange-500/50" />
      ...
      <div className="rounded-lg border p-3" style={{ borderColor: `${ACCENT}${OPACITY_20}`, backgroundColor: `${ACCENT}05` }}>
        ...
        <label className="flex items-center gap-1.5 text-xs font-mono text-text-muted mb-3">
          ...
          <input type="number" min={100} step={1000} value={evTargetGold}
            ...
            className="w-24 bg-surface-deep/50 border border-border/40 rounded px-1.5 py-0.5 text-xs font-mono text-text text-right focus:outline-none focus:ring-1 focus:ring-orange-500/50" />
          <span>g</span>
        </label>
        <div className="space-y-1.5">
          {evResults.map(r => {
