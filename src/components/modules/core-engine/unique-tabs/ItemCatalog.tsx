...
import { STATUS_COLORS, TabHeader, PipelineFlow, SectionLabel, LoadingSpinner, RadarChart, DiffViewer } from './_shared';
  ...
  return (
    <div className="space-y-4">
      ...
      <SurfaceCard level={2} className="p-4">
        ...
        <p className="text-xs text-text-muted mt-1 mb-4">Compare item power distribution across 5 budget axes. Outer ring = rarity cap.</p>
      ...
      <SurfaceCard level={2} className="p-4">
        ...
        <p className="text-xs text-text-muted mt-1 mb-4">Sunburst view: center = Rare rarity, first ring = prefix count, second ring = specific affixes.</p>
      ...
      <SurfaceCard level={2} className="p-4">
        ...
        <p className="text-xs text-text-muted mt-1 mb-4">Paper-doll layout with equipped items and stat contribution summary.</p>
        <div className="flex flex-wrap gap-6 items-start justify-center">
          {/* Paper doll SVG */}
          <div className="relative" style={{ width: 220, height: 200 }}>
            <svg width={220} height={200} viewBox="0 0 220 200" className="absolute inset-0">
      ...
      <SurfaceCard level={2} className="p-4">
        ...
        <p className="text-xs text-text-muted mt-1 mb-4">Side-by-side comparison with stat deltas.</p>
      ...
      <SurfaceCard level={2} className="p-4">
        ...
        <p className="text-xs text-text-muted mt-1 mb-4">Recipe card showing materials, output, and affix probability ranges.</p>
      ...
      <SurfaceCard level={2} className="p-4">
        ...
        <p className="text-xs text-text-muted mt-1 mb-4">Trace drop sources for Crystal Staff: enemies, loot tables, and zones.</p>
      ...
      <SurfaceCard level={2} className="p-4">
        ...
        <p className="text-xs text-text-muted mt-1 mb-4">Slots by type, rarity breakdown, total value, and cleanup suggestions.</p>
      ...
      <SurfaceCard level={2} className="p-4">
        ...
        <p className="text-xs text-text-muted mt-1 mb-4">Track set collection progress and bonus thresholds.</p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {ITEM_SETS.map(set => {
      ...
      <SurfaceCard level={2} className="p-4">
        ...
        <p className="text-xs text-text-muted mt-1 mb-4">Stat values across item levels 1-50 with min-max bands.</p>
        <div className="flex justify-center">
          <ItemScalingChart lines={SCALING_LINES} width={320} height={140} />
        </div>
      ...
      <SurfaceCard level={2} className="p-4">
        ...
        <p className="text-xs text-text-muted mt-1 mb-4">Compare expected vs actual inventory rarity at Level 14.</p>
