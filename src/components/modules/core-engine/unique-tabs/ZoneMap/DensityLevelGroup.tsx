    ...
    <>
      ...
      <BlueprintPanel color={STATUS_ERROR} className="p-3">
        ...
        <HeatmapGrid
          ...
          accent={STATUS_ERROR}
        />
        <div className="flex items-center gap-4 mt-3 pt-2 border-t border-border/40 text-xs font-mono uppercase tracking-[0.15em] text-text-muted">
            ...
            return (
              <div key={budget.label} className="space-y-1.5">
                ...
                <div className="relative h-5 bg-surface-deep rounded-md overflow-hidden border border-border/30">
                  ...
                  <span className="absolute inset-0 flex items-center justify-center text-xs font-mono font-bold text-text">
                    {Math.round(pct)}%
                  </span>
                </div>
              </div>
