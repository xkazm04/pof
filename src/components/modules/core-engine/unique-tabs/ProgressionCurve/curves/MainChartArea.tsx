...
import { STATUS_INFO,
  withOpacity, OPACITY_8, OPACITY_12, OPACITY_20,
    ...
    <BlueprintPanel color={compareMode ? STATUS_INFO : ACCENT} className="lg:col-span-2 p-5">
      <div className="flex justify-between items-center mb-2.5">
        <SectionHeader
          ...
          color={ACCENT}
        />
        <div className="text-xs font-mono uppercase tracking-[0.15em] px-3 py-1.5 rounded-full border" style={{ color: ACCENT, backgroundColor: `${withOpacity(ACCENT, OPACITY_8)}`, borderColor: `${withOpacity(ACCENT, OPACITY_12)}` }}>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-3 mt-2">
            <div>
              ...
              <div className="w-full h-[220px] bg-surface-deep/30 rounded-xl relative p-3 border border-border/40" style={{ borderColor: `${withOpacity(STATUS_INFO, OPACITY_20)}` }}>
            ...
            <div>
              ...
              <div className="w-full h-[220px] bg-surface-deep/30 rounded-xl relative p-3 border border-border/40" style={{ borderColor: `${withOpacity(ACCENT, OPACITY_20)}` }}>
