...
import {
  ...
  withOpacity, OPACITY_15, OPACITY_50,
  ...
  return (
    <BlueprintPanel color={ACCENT_ORANGE} className="p-3">
      <div className="space-y-4">
        ...
        {/* Level Slider */}
        <div className="flex items-center gap-3 px-3 py-2 rounded-lg bg-surface-deep/50 border" style={{ borderColor: `${withOpacity(ACCENT_ORANGE, OPACITY_15)}` }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          <div className="space-y-1">
            <div className="flex items-center gap-1.5 pb-1 border-b" style={{ borderColor: `${withOpacity(STATUS_ERROR, OPACITY_15)}` }}>
              <Swords className="w-3 h-3" style={{ color: STATUS_ERROR, filter: `drop-shadow(0 0 3px ${withOpacity(STATUS_ERROR, OPACITY_50)})` }} />
          ...
          {/* Defense */}
          <div className="space-y-1">
            <div className="flex items-center gap-1.5 pb-1 border-b" style={{ borderColor: `${withOpacity(ACCENT_EMERALD, OPACITY_15)}` }}>
              <Shield className="w-3 h-3" style={{ color: ACCENT_EMERALD, filter: `drop-shadow(0 0 3px ${withOpacity(ACCENT_EMERALD, OPACITY_50)})` }} />
          ...
          {/* Stamina Economy */}
          <div className="space-y-1">
            <div className="flex items-center gap-1.5 pb-1 border-b" style={{ borderColor: `${withOpacity(ACCENT_CYAN, OPACITY_15)}` }}>
              <Zap className="w-3 h-3" style={{ color: ACCENT_CYAN, filter: `drop-shadow(0 0 3px ${withOpacity(ACCENT_CYAN, OPACITY_50)})` }} />
          ...
          {/* Mobility */}
          <div className="space-y-1">
            <div className="flex items-center gap-1.5 pb-1 border-b" style={{ borderColor: `${withOpacity(ACCENT_VIOLET, OPACITY_15)}` }}>
              <Activity className="w-3 h-3" style={{ color: ACCENT_VIOLET, filter: `drop-shadow(0 0 3px ${withOpacity(ACCENT_VIOLET, OPACITY_50)})` }} />
