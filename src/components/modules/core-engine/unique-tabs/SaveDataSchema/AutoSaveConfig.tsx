...
import { ACCENT, AUTO_SAVE_TRIGGERS, AUTO_SAVE_CONFIG } from './data';
      ...
      <div className="p-4 space-y-4 relative z-10">
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between font-mono text-xs">
            <span className="text-[10px] font-mono uppercase tracking-[0.15em] text-text-muted">Save Interval</span>
          ...
          <div className="relative h-2 rounded-full border border-border/10" style={{ backgroundColor: `${ACCENT}12` }}>
            ...
            />
            <div className="absolute top-full mt-1 flex justify-between w-full text-[10px] font-mono text-text-muted">
              <span>30s</span>
              <span>120s</span>
              <span>300s</span>
            </div>
        ...
        <div className="space-y-1.5 mt-6">
          <span className="text-[10px] font-mono uppercase tracking-[0.15em]" style={{ color: ACCENT }}>Triggers</span>
            ...
            {AUTO_SAVE_TRIGGERS.map(trigger => (
              ...
              >
                ...
                <div className="min-w-0">
                  <div className="text-cyan-200 font-bold text-[10px] uppercase tracking-[0.15em]">{trigger.label}</div>
                  <div className="text-[10px] text-text-muted truncate">{trigger.description}</div>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-2">
          ...
          <div className="relative p-3 rounded-lg border overflow-hidden" style={{ borderColor: `${ACCENT}20`, backgroundColor: `${ACCENT}08` }}>
            <div className="text-[10px] font-mono uppercase tracking-[0.15em] mb-1.5 text-text-muted">Combat Save</div>
            ...
            <div className="text-[10px] text-text-muted mt-0.5">Disabled during boss fights</div>
          </div>
          <div className="relative p-3 rounded-lg border overflow-hidden" style={{ borderColor: `${ACCENT}20`, backgroundColor: `${ACCENT}08` }}>
            <div className="text-[10px] font-mono uppercase tracking-[0.15em] mb-1.5 text-text-muted">Compression</div>
            <div className="flex items-center gap-1.5">
            ...
            <div className="text-[10px] text-text-muted mt-0.5">LZ4 fast compression</div>
          </div>
        </div>
      </div>
    </BlueprintPanel>
