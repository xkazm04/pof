            ...
            return (
              <div key={step.id} className="flex items-center gap-1">
                <motion.div
                  ...
                  style={isCurrent ? {
                    borderColor: ACCENT_CYAN, backgroundColor: withOpacity(ACCENT_CYAN, OPACITY_5),
                    color: ACCENT_CYAN_LIGHT, boxShadow: `0 0 10px ${withOpacity(ACCENT_CYAN, OPACITY_20)}`,
                  } : isComplete ? {
                    borderColor: withOpacity(ACCENT_EMERALD, OPACITY_40), backgroundColor: withOpacity(ACCENT_EMERALD, OPACITY_5),
                ...
                {i < arr.length - 1 && (
                  <div className={`w-6 h-px ${isComplete ? '' : 'bg-border/20'}`} style={isComplete ? { backgroundColor: withOpacity(ACCENT_EMERALD, OPACITY_40) } : undefined} />
                )}
              </div>
            );
          })}
