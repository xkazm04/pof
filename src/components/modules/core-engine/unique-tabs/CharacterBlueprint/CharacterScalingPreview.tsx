    ...
    <BlueprintPanel className="p-4">
      ...
      <div className="flex items-center gap-3 mb-4">
        ...
        <motion.span
          ...
          style={{ color: ACCENT_VIOLET, textShadow: `0 0 12px ${ACCENT_VIOLET}40` }}
        >
          {scalingLevel}
        </motion.span>
      </div>
        ...
        {SCALING_PROPS.map((prop, i) => {
          ...
          return (
            <motion.div
              ...
              style={{ borderColor: `${prop.color}20`, backgroundColor: `${prop.color}06` }}
            >
              {/* Hover glow */}
              ...
              <div className="flex justify-between items-center mb-2 relative z-[1]">
                ...
                <motion.span
                  ...
                  style={{ color: prop.color, textShadow: `0 0 8px ${prop.color}40` }}
                >
