...
import { ACCENT_CYAN, ACCENT_EMERALD, ACCENT_VIOLET, ACCENT_ORANGE } from '@/lib/chart-colors';
            ...
            {DODGE_TRAJECTORIES.map((traj, i) => (
              <motion.span
                ...
                style={{
                  ...
                  backgroundColor: `${traj.color}06`,
                }}
              >
                <span className="w-3 h-px rounded-full" style={{ backgroundColor: traj.color, boxShadow: `0 0 4px ${traj.color}` }} />
                #{traj.id}
              </motion.span>
            ))}
          </div>
