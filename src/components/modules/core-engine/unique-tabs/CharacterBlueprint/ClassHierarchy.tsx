      ...
      {depth > 0 && (
        <svg className="absolute pointer-events-none" style={{ left: 4, top: 0, width: 28, height: '100%' }}>
          <motion.line
            ...
            stroke={`${node.color}40`} strokeWidth="1.5"
        ...
        >
          ...
          <span
            ...
            style={{
              ...
              color: node.color,
              textShadow: `0 0 16px ${node.color}30`,
              boxShadow: hovered ? `0 0 16px ${node.color}20, inset 0 0 16px ${node.color}08` : 'none',
            }}
          >
            {/* Inner glow line at top */}
            <span className="absolute top-0 left-0 right-0 h-px" style={{ background: `linear-gradient(90deg, transparent, ${node.color}40, transparent)` }} />
            {node.name}
          </span>
          ...
          {node.crossRef && (
            <span
              ...
              style={{ backgroundColor: `${STATUS_ERROR}10`, color: STATUS_ERROR, borderColor: `${STATUS_ERROR}30` }}>
