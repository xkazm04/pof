    ...
    <BlueprintPanel color={ACCENT} className="p-4">
      ...
      <div className="space-y-3">
        {STATE_DURATIONS.map((d) => {
          ...
          return (
            <div key={d.state} className="flex items-center gap-3">
              <span className="text-xs font-mono font-bold w-20" style={d.hasOutlier ? { color: STATUS_WARNING } : undefined}>{d.state}</span>
              <div className="flex-1 relative h-6 rounded bg-surface-deep">
                ...
                <div
                  ...
                  style={{
                    ...
                    backgroundColor: d.hasOutlier ? withOpacity(STATUS_WARNING, OPACITY_20) : withOpacity(ACCENT, OPACITY_15),
                    border: `1px solid ${withOpacity(d.hasOutlier ? STATUS_WARNING : ACCENT, OPACITY_30)}`,
                  }}
                />
                {/* Median line */}
                <div
