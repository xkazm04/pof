          ...
          return (
            ...
            >
              <button
                ...
                className="w-full flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-surface-hover/30 transition-colors text-left cursor-pointer"
              >
    ...
    <BlueprintPanel color={ACCENT} className="p-4">
      ...
      <div className="flex items-center gap-4">
        <svg width={120} height={120} viewBox="0 0 120 120" className="overflow-visible flex-shrink-0">
          <circle cx={60} cy={60} r={52} fill="none" stroke={withOpacity(OVERLAY_WHITE, OPACITY_6)} strokeWidth="1" />
          <circle cx={60} cy={60} r={28} fill="none" stroke={withOpacity(OVERLAY_WHITE, OPACITY_4)} strokeWidth="1" />
          <line x1={60} y1={8} x2={60} y2={112} stroke={withOpacity(OVERLAY_WHITE, OPACITY_4)} strokeWidth="1" />
          <line x1={8} y1={60} x2={112} y2={60} stroke={withOpacity(OVERLAY_WHITE, OPACITY_4)} strokeWidth="1" />
          <circle cx={60} cy={104} r={3} fill={withOpacity(OVERLAY_WHITE, OPACITY_30)} stroke={withOpacity(OVERLAY_WHITE, OPACITY_50)} strokeWidth="1" />
