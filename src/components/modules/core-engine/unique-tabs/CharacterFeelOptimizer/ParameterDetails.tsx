        ...
        return (
          <div key={cat}>
            ...
            >
              ...
              <span className="text-[10px] font-mono uppercase tracking-[0.15em] font-bold" style={{ color: catColor }}>
                {cat}
              </span>
                    ...
                    {fields.map((field) => {
                      ...
                      return (
                        <div key={field.key} className="px-2 py-1 rounded hover:bg-surface/20 transition-colors group">
                          ...
                          {rationale && (
                            <div className="text-[10px] font-mono text-text-muted mt-0.5 pl-0 opacity-0 group-hover:opacity-100 transition-opacity leading-relaxed">
                              {rationale}
                            </div>
                          )}
                        </div>
