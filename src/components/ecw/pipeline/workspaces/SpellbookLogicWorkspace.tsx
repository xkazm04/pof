...
export function SpellbookLogicWorkspace({ entity }: TrackWorkspaceProps) {
  ...
  const generateCpp = () =>
    void cli.execute(TaskFactory.generateGasEffects('arpg-gas', { ref, effects: spec.effects, tagRules: spec.tagRules, scalars: { manaCost: a.manaCost, cooldown: a.cooldown, damage: a.damage } }, getAppOrigin(), `Gen C++ · ${entity.name}`));
